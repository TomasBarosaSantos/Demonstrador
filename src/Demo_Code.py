...
svr_model = pkl.load(open('SVR_Model.pkl', 'rb'))
...
df_Forecast_Data = pd.read_csv('dataPowerForecast.csv', index_col=0, parse_dates=True)
...
app.layout = html.Div([
    ...
    html.Img(
        src=b64_image('Branding ATE/Logos ATE/Logos ATE_PT/logo cor_pt-01.png'),
        style={'width': '22%', 'height': '22%'}
        ),

    html.Img(
        src=b64_image('Branding ATE/Barra Assinaturas PRR/Barra PRR.png'),
...
def dropdown_output(dropdown):
    if dropdown == 'Overall System':
        return html.Div([
            ...
            html.Div([
                html.Img(
                    src=b64_image('Optimisação/System.png'),
        ...
        return html.Div([
            ...
            html.Div([
                html.Img(
                    src=b64_image('consum_fore/features.png'),
                    style={'width': '60%', 'height': '60%'}
                ),
            ], className="twelve columns", style={'textAlign': 'center'}),
            ...
            html.Div([
                html.Img(
                    src=b64_image('consum_fore/feature_importance.png'),
            ...
            html.Div([
                html.Div([
                    html.Img(
                        src=b64_image('consum_fore/lr_r2.png'),
                        style={'width': '120%', 'height': '120%'}
                    ),
                ], className="two columns"),
                html.Div([
                    html.Img(
                        src=b64_image('consum_fore/rf_r2.png'),
                        style={'width': '120%', 'height': '120%'}
                        ),
                ], className="two columns"),
                html.Div([
                    html.Img(
                        src=b64_image('consum_fore/ann_r2.png'),
                        style={'width': '120%', 'height': '120%'}
                        ),
                ], className="two columns"),
                html.Div([
                    html.Img(
                        src=b64_image('consum_fore/xgboost_r2.png'),
                        style={'width': '120%', 'height': '120%'}
                        ),
                ], className="two columns"),
                html.Div([
                    html.Img(
                        src=b64_image('consum_fore/svr_r2.png'),
                        style={'width': '120%', 'height': '120%'}
                        ),
                ], className="two columns"),
            ],className="twelve columns", style={'textAlign': 'center'}),
            ...
            html.Div([
                html.Img(
                    src=b64_image('consum_fore/rmse_boxplot.png'),
                    style={'width': '35%', 'height': '35%'}
                    ),
            ], className="twelve columns", style={'textAlign': 'center'}),
        ...
        return html.Div([
            ...
            html.Div([
                html.Img(
                    src=b64_image('PV Gen/fluxograma_SA.png'),
            ...
            html.Div([
                html.Img(
                    src=b64_image('PV Gen/SVM_params.png'),
            ...
            html.Div([
                html.Img(
                    src=b64_image('PV Gen/correlation_matrix.png'),
                    style={'width': '30%', 'height': '30%'}
                ),
            ], className="twelve columns", style={'textAlign': 'center'}),
            ...
            html.Div([
                html.Img(
                    src=b64_image('PV Gen/r2_graph.png'),
                    style={'width': '30%', 'height': '30%'}
                ),
            ], className="twelve columns", style={'textAlign': 'center'}),
        ...
        return html.Div([
            ...
            html.Div([
                html.Img(
                    src=b64_image('Optimisação/Fluxograma.png'),
                    style={'width': '20%', 'height': '20%'}
                ),
            ], className="twelve columns", style={'textAlign': 'center'}),
            ...
            html.Div([
                html.Img(
                    src=b64_image('Optimisação/equation-1.png'),
            ...
            html.Div([
                html.Img(
                    src=b64_image('Optimisação/LCOS_Equation-1.png'),
            ...
            html.Div([
                ...
                html.Img(
                    src=b64_image('Optimisação/Savings_Sensitivity.png'),
                    style={'width': '50%', 'height': '50%'}
                ),
            ], className="twelve columns", style={'textAlign': 'center'}),
            html.Div([
                ...
                html.Img(
                    src=b64_image('Optimisação/NPV_Sensitivity.png'),
                    style={'width': '50%', 'height': '50%'}
                ),
            ], className="twelve columns", style={'textAlign': 'center'}),
            html.Div([
                ...
                html.Img(
                    src=b64_image('Optimisação/DPBP_Sensitivity.png'),
                    style={'width': '50%', 'height': '50%'}
                ),
            ], className="twelve columns", style={'textAlign': 'center'}),
        ])
        ...
        return html.Div([
            html.Div([
                html.Img(
                    src=b64_image('INESCTECLogotipo_CORPositivo_RGB.jpg'),
